...
barba.hooks.after((ww) => {
    ...
    script.dataset.inner_page = true;
    script.src = `./assets/scripts/${scriptName}.bundle.js`;
...
formWrapperCall.forEach(el => {
    el.addEventListener('click', function(evt) {
        gsap.timeline()
            ...
            .fromTo(
                '.form-wrapper-left>*, .form-wrapper-right form>*', { y: 50, autoAlpha: 0 }, { y: 0, autoAlpha: 1 },
...
function closeForm() {
    ...
    .to('.form-wrapper-succes-layer', { autoAlpha: 0, duration: 0.25 })
        .fromTo(
            '.form-wrapper-left>*, .form-wrapper-right form>*', { y: 0, autoAlpha: 1 }, { y: 50, autoAlpha: 0 },
