...
const testData = [
    'Квартира 2А Скористайтесь функцією 3D-туру квартирою, і Ви впевнитесь у зручності її планування та функціональності.',
    'Квартира 1Б Скористайтесь функцією 3D-туру квартирою, і Ви впевнитесь у зручності її планування та функціональності.',
...
export default function screen9Handler(scroller) {
    ...
    textBlock.textContent = testData[0];
